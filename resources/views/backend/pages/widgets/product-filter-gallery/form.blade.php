        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-dark bg-dark">
                    ...
                    <form action="{{ route('admin.widget.filter-gallery.index') }}" method="post">
                        @csrf
                                ...
                                <div class="col-3 mx-auto">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input type="checkbox" class="content-show" name="show" {{ $productFilterGallerySection?($productFilterGallerySection->show?'checked':''):'checked' }}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg mb-3">
                                    <input type="text" name="title" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm"
                                           placeholder="{{__('Section Title')}}" value="{{ $productFilterGallerySection?$productFilterGallerySection->title:old('title') }}">
                                    <br>
                                    @if ($errors->has('title'))
                                ...
                                <div class="input-group input-group-lg mb-3">
                                    <input type="number" name="number_of_content" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm"
                                           placeholder="{{__('Number of content')}}" value="{{ $productFilterGallerySection?$productFilterGallerySection->number_of_content:old('number_of_content') }}">
                                    <br>
