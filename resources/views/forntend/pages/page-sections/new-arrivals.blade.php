                ...
                <div class="col-6 col-lg-2 col-md-3 col-sm-4 product-default inner-quickview inner-icon">
                    <figure>
                        ...
                        <div class="btn-icon-group">
                            <button class="btn-icon myCartBtn btn-add-cart" data-role="{{ $newArrivalProduct->id }}"><i class="icon-bag"></i></button>
                        </div>
                    ...
                    <div class="product-details">
                        ...
                        <h2 class="product-title">
                            <a href="javascript:void(0)">{{ substr($newArrivalProduct->name, 0, 16) }}</a>
                        </h2>
                        <div class="price-box">
