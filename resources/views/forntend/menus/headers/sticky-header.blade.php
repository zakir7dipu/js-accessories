                    ...
                    <div class="megamenu megamenu-fixed-width">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <ul>
                                            <li><a href="javascript:void(0)">Fullwidth Banner<span class="tip tip-hot">Hot!</span></a></li>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="javascript:void(0)">4 Columns Products <span class="tip tip-new">New</span></a></li>
                            ...
                            <div class="col-lg-4">
                                <div class="banner">
                                    <a href="#">
                                        <img src="{{ asset('forntend/assets/images/menu-banner-2.jpg') }}" alt="Menu banner">
                                    </a>
                                </div><!-- End .banner -->
                            </div><!-- End .col-lg-4 -->
                        </div>
                    ...
                    <div class="megamenu">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="banner">
                                    <a href="#">
                                        <img src="{{ asset('forntend/assets/images/menu-banner.jpg') }}" alt="Menu banner" class="product-promo">
                                    </a>
                                </div><!-- End .banner -->
                            </div><!-- End .col-lg-4 -->
                        </div><!-- End .row -->
