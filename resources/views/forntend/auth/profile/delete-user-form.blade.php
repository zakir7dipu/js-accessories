        ...
        <div class="card-body p-4">
            <div class="row">
                ...
                <div class="col-md-8 p-5">
                    ...
                    <button type="button" class="btn btn-primary rounded" onclick="deleteAccountAlert();">{{ __('Delete Account') }}</button>
                </div>
            </div>
        </div>
    </div>

    <form action="{{ route('client.delete-account') }}" method="post" id="deleteForm">
        @csrf
