<div class="row">
        ...
        <div class="card card-dark py-1">
            ...
            <div class="card-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form action="{{ route('client.profile') }}" method="post" enctype="multipart/form-data" class="wma-form">
                            @csrf
                            <div class="">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <div class="input-group input-group-lg mb-3">
                                            <input type="tel" name="phone" id="phone" value="{{Auth::user()->profile?Auth::user()->profile->phone:''}}" class="form-control rounded"
                                        ...
                                        <p class="mb-1 font-weight-bold"><label for="companyName">{{ __('Company Name') }}:</label> </p>
                                        <div class="input-group input-group-lg mb-3">
                                            <input type="text" name="company_name" id="companyName" value="{{Auth::user()->profile?Auth::user()->profile->company_name:''}}" class="form-control rounded"
                                                   aria-label="Large" aria-describedby="inputGroup-sizing-sm">
                                            <br>
                                        ...
                                        <p class="mb-1 font-weight-bold"><label for="designation">{{ __('Designation') }}:</label> </p>
                                        <div class="input-group input-group-lg mb-3">
                                            <input type="text" name="designation" id="designation" value="{{Auth::user()->profile?Auth::user()->profile->designation:''}}" class="form-control rounded"
                                                   aria-label="Large" aria-describedby="inputGroup-sizing-sm">
                                            <br>
                                ...
                                <div class="float-right">
                                    <button class="btn btn-wave-light rounded btn-primary btn-lg" type="submit">{{ __('Save') }}</button>
                                </div>
    ...
    <div class="col-12">
        <div class="card card-dark py-1">
            <div class="card-body p-4">
                <form action="{{ route('client.profile-info') }}" method="post">
                    @csrf
